...
class SalesPopup extends Component {
    constructor(props) {
        super(props);
        this.state = {
            cid: '',
    ...
    handleSubmit = (event) => {
        fetch('http://localhost:3001/addpurchase', {
            method: 'POST',
    ...
    render() {
        ...
        <div className='popup'>
            <div className='popup_inner'>
                ...
                <div className='row'>
                    <h4 className='col-sm-3 offset-sm-4 text-center'>New Purchase</h4>
                    <button className='col-sm-1 btn btn-secondary btn-sm offset-sm-3' onClick={this.props.closePopup}>X</button>
                </div>
                <div className='row'>
                    <p className='col-sm-12 text-center'>Awesome you tricked a new unsuspecting customer! Enter info below</p>
                </div>
